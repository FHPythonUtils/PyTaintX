...
from pytaintx.usage import parse_args
...
class UsageTest(BaseTestCase):
    def test_no_args(self):
        ...
        EXPECTED = """usage: python -m pytaintx [-h] [-v] [-a ADAPTOR] [-pr PROJECT_ROOT]
  ...
  -s, --screen          Prints colorful report.\n"""
    ...
    def test_valid_args_but_no_targets(self):
        ...
        EXPECTED = """usage: python -m pytaintx [-h] [-v] [-a ADAPTOR] [-pr PROJECT_ROOT]
                     ...
                     [--dont-prepend-root] [--no-local-imports] [-u] [-j | -s]
                     targets [targets ...]
python -m pytaintx: error: the following arguments are required: targets\n"""
...
#         EXPECTED = """usage: python -m pytaintx [-h] [-f FILEPATH] [-a ADAPTOR] [-pr PROJECT_ROOT]
#                      [-b BASELINE_JSON_FILE] [-j] [-m BLACKBOX_MAPPING_FILE]
#                      [-t TRIGGER_WORD_FILE] [-o OUTPUT_FILE] [-trim] [-i]
# python -m pytaintx: error: argument -i/--interactive: not allowed with argument -trim/--trim-reassigned-in\n"""
